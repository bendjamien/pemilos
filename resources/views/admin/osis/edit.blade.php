            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="file-upload">
                        <input type="file" name="photo_ketua" id="photo_ketua" class="@error('photo_ketua') is-invalid @enderror" onchange="previewImage(this, 'preview-ketua')">
                    ...
                    <div class="current-image">
                        <img src="{{ asset('storage/' . $osisCandidate->photo_ketua) }}" alt="Foto Ketua Saat Ini">
                        <p>Foto Ketua Saat Ini</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="file-upload">
                        <input type="file" name="photo_wakil" id="photo_wakil" class="@error('photo_wakil') is-invalid @enderror" onchange="previewImage(this, 'preview-wakil')">
                    ...
                    <div class="current-image">
                        <img src="{{ asset('storage/' . $osisCandidate->photo_wakil) }}" alt="Foto Wakil Saat Ini">
        ...
        <div class="form-section">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <textarea name="vision" id="vision" rows="3" class="form-control @error('vision') is-invalid @enderror" required>{{ old('vision', $osisCandidate->vision) }}</textarea>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <textarea name="mission" id="mission" rows="4" class="form-control @error('mission') is-invalid @enderror" required>{{ old('mission', $osisCandidate->mission) }}</textarea>
                </div>
