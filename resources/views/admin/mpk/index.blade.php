...
<style>
    ...
    .photo-container {
        margin-top: -40px; /* Diperkecil dari -60px */
        display: flex;
    ...
    .candidate-photo {
        width: 70px; /* Diperkecil dari 100px */
        height: 70px; /* Diperkecil dari 100px */
        border-radius: 50%;
        object-fit: cover;
    ...
    .candidate-photo.wakil {
        margin-left: -20px; /* Diperkecil dari -30px */
        z-index: 1;
    }
...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h2 class="mb-0">Daftar Kandidat MPK</h2>
            <p class="mb-0 opacity-75">Kelola kandidat untuk pemilihan MPK</p>
        </div>
        <a href="{{ route('admin.mpk-candidates.create') }}" class="btn btn-light rounded-pill">
...
<div class="row">
    ...
    <div class="col-xl-4 col-md-6 mb-4">
        <div class="candidate-grid-card">
            <div class="card-header-bg">
                <div class="candidate-badge">MPK</div>
            </div>
            ...
            <div class="card-footer">
                <a href="{{ route('admin.mpk-candidates.edit', $candidate->id) }}" class="btn btn-action btn-edit">
    ...
    <div class="col-12">
        <div class="empty-state">
            ...
            <h5>Belum Ada Kandidat MPK</h5>
            <p>Silakan tambahkan kandidat MPK untuk memulai pemilihan.</p>
